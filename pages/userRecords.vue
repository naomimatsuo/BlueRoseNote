<template>
  <div>
    <div class="mb-2 d-flex justify-content-between">
      <button id="tweet_btn" type="button" class="btn btn-lg btn-block btn-category bg-transparent border border-primary text-primary rounded-0 mr-1" @click="toggleTweetComponent">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          <path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" />
          <path d="M3 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 6zm0 2.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z" />
        </svg>
      </button>
      <button id="temp_btn" type="button" class="btn btn-lg btn-block btn-category bg-transparent border border-primary rounded-0 mr-1 mt-0" @click="toggleTempComponent">体温</button>
      ...
      <button id="medicine_btn" type="button" class="btn bgn-lg btn-block btn-category bg-transparent border border-primary rounded-0 mr-1 mt-0" @click="toggleMedicineComponent">薬</button>
      <button id="appetite_btn" type="button" class="btn bgn-lg btn-block btn-category bg-transparent border border-primary rounded-0 mt-0" @click="toggleAppetiteComponent">食事</button>
    </div>
    <!-- new record -->
    <div class="h-100">
      <div>
